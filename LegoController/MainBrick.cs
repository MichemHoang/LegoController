...
namespace LegoController
{
    class MainBrick
    {
        ...
        {
            Ev3Brick.BatchCommand.TurnMotorAtPowerForTime(OutputPort.C, -30, 1500, EmergencyBrake);
            Ev3Brick.BatchCommand.TurnMotorAtPowerForTime(OutputPort.B, +30, 1500, EmergencyBrake);
            await Ev3Brick.BatchCommand.SendCommandAsync();
        }
